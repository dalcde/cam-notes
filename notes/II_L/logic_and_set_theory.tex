...
note that this does not contradict G\"odel's completeness theory. The completeness theorem tells us that if $p$ holds in \emph{every} model of PA (not just in $\N$), then $PA\vdash p$.
