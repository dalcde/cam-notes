...
\begin{prop}[Continuous induction v1]
  ...
  \begin{enumerate}
    \item $a\in A$
    \item If $x\in A$ and $x\not= b$, then $\exists y\in A$ with $y\geq x$.
...
\begin{proof}
  ...
  Let $I_\gamma$ be an open interval containing $x$. Then it contains $(x - \varepsilon, ]$ for some $\epsilon > 0$. Pick $y\in A$ such that $y\in (x - \varepsilon, x]$. Now combine $I_\gamma$ with a finite subcover of $[a, y]$ to get a finite subcover of $[a, x]$. So $x\in A$.
