...
\begin{defi}[Singular disc diagram]\index{singular disc diagram}\index{disc diagram}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (0, 1) -- (-1, 2);
      \fill (-1.5, 2.5) circle [radius=1.414];
  ...
  \]
\end{defi}
If we orient $\R^2$, then $D$ has a well-defined boundary cycle. % insert picture
...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (0, 0) -- (-2, 2) node [pos=0.5] {$g_1$};
      \draw (0, 0) -- (-1, 2) node [pos=0.5] {$g_2$};
      \draw (0, 0) -- (0, 2) node [pos=0.5] {$g_3$};
      \draw (0, 0) -- (1, 2) node [pos=0.5] {$g_4$}; % replace with \ldots
      \draw (0, 0) -- (2, 2) node [pos=0.5] {$g_d$};

      \draw (-2, 2.3) circle [radius=0.3]; % label as r_i^{\pm}
      \draw (-1, 2.3) circle [radius=0.3];
      \draw (0, 2.3) circle [radius=0.3];
      \draw (1, 2.3) circle [radius=0.3];
      \draw (2, 2.3) circle [radius=0.3];
    \end{tikzpicture}
  \end{center}
...
\begin{thm}[Novikov--Boone theorem]
...
\begin{thm}[Filling theorem (Gromov, Bridson, Burillo--Taback)] % insert name
