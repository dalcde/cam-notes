...
\]
is called a \term{generalized ideal class group}, or the \term{ray class group} modulo $\mathfrak{m}$.
...
Note that if $m = 0$, then this map is the inverse of the map given by content. However, in general, it is not simply (the inverse of) the ``prime-to-$S$'' content map, even for ideles whose content is prime to $S$. According to Fr\"olich, this is the ``\term{fundamental mistake of class field theory}''.
