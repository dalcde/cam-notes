...
\begin{proof}
  ...
  \begin{enumerate}
    \item If there is an $A_{1j}$ not divisble by $A_{11}$, then we can use the Euclidean algorithm to write
      \[
        A_{1j} = q A_{11} + r.
      \]
