...
\begin{proof}
  ...
  \[
    \frac{H}{H \cap K} = \frac{HK}{K}.\qedhere
  \]
\end{proof}
...
Being finitely presented means I can tell you everything about the module with finitely many paper. More precisely, if $\{m_1, \cdots, m_k\}$ generate $M$ and $\{n_1, n_2, \cdots, n_\ell\}$ generate $\ker(\phi)$, then each
\[
