...
%      \draw [mred] circle [radius=1.3];
%      \draw [mred] circle [radius=2.6];
      ...
      \draw [mred] (0, 1.3) -- (0, 2.6);
      \draw [mred] (0, -1.3) -- (0, -2.6); % can insert arrows, anticlockwise.

      \node [circ] at (2, 0) {};
      \node [right] at (2, 0) {$w$}; % label \tilde{\gamma} and \tilde\tilde\gamma

%      \node [right] at (2.6, 0) {$\tilde{\gamma}$};
%      \node [left] at (-2.6, 0) {$\tilde{\tilde{\gamma}}$};
    \end{tikzpicture}
  \end{center}
  ...
  \[
    f(w) = \frac{1}{2\pi i} \int_{\tilde{\gamma}}\frac{R(z)}{z - w}\;\d z
  \]
  and
  \[
