...
We can also understand this topologically as follows: since $\SU(2)$ is defined by two complex points $a, b \in \C$ such that $|a|^2 + |b|^2$, we can view it as three-sphere $S^3$ in $\SO(3)$.
...
\begin{eg}
  We will not do this in full detail --- the details are to be filled in the third example sheet.
