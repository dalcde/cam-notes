...
\begin{proof}
  This is clear is $\Re z_1 = \Re z_2$ --- we just pick the vertical half-line through them, and it is clear this is the only possible choice.
...
\begin{defi}[(Parametrized) smooth embedded surface]
  ...
  \begin{enumerate}
    ...
    \item For all $Q = \sigma(P)$, the partial derivatives $\frac{\partial \sigma}{\partial u}(P)$ and $\frac{\partial \sigma}{\partial v}(P)$ are linearly independent.
  \end{enumerate}
\end{defi}
