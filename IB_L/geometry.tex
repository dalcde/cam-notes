...
If $p \in \mathring{Q}$, then $f$ restricted to an open disc about $P$ is an isometry (onto the image, a subset of $\R^2$). Thus we say $d$ is a \emph{locally Euclidean metric}.
