...
\end{eg}
Choosing the parameters for the RK method to maximize order is \emph{hard}. Consider the simplest case, the $2$-stage explicit method. The general formula is
\[
