...
\begin{thm}[Classification of compact surfaces]
  ...
  \begin{enumerate}
    \item The \emph{orientable surface of genus $g$}, $F_g$ includes the following (please excuse my drawing skills):
...
\begin{eg}
  The surface of genus two, confusingly written $F_2$, we start with what we had for a torus:
  \begin{center}
