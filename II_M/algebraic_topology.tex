...
\begin{thm}[Mayer-Vietoris theorem]
  ...
  \[
    ...
    \end{tikzcd}
  \]
  Then there exists some natural homomorphism $\partial_*$ such that
  \[
    \begin{tikzcd}
  ...
  \]
\end{thm}
Here $A \oplus B$ is the direct sum of the two groups, which may also be known as the Cartesian product.
