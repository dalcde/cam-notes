...
\begin{defi}[Evenly covered]
  ...
  \[
    p^{-1}(U) \cong \coprod_{\alpha \in \Lambda}V_\alpha, % change to reverse pi
  \]
...
\begin{eg}
  $\R \to S^1$ by $t \mapsto 2^{2\pi i t}$ is a covering space.
  \begin{center}
    \begin{tikzpicture}
      \draw [decorate, decoration={aspect=0.3, coil, amplitude=0.6cm}] (0, 1) -- (0, 3.65);
