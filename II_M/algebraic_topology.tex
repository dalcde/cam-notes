...
\begin{proof}
  ...
  \[
    (h \circ f) \circ (g \circ k) = h \circ (f \circ g) \circ k = h \circ \id_Y \circ k = h \circ k = \id_Z.
  \]
  Similarly,
  \[
    (g \circ k) \circ (h \circ f) = g \circ (k \circ h) \circ f = g \circ \id_Y \circ f = g \circ f = \id_X.
  \]
  So done.
\end{proof}
