...
\end{eg}
We see that these results are rather unpleasant and the spectrum behaves rather unlike the finite dimensional cases. Fortunately, we will later see that if we put some more restrictions on our operators, then we can get a much nicer result.
\end{document}
