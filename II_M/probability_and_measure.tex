...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item If $f_n$ is simple and $f$ is an indicator function, then the theorem holds.
    \item If $f_n$ and $f$ are simple, then the theorem holds.
    \item If $f_n$ are simple and $f$ is non-negative measurable, then the theorem holds.
    \item If $f_n$ and $f$ are non-negative measurable, then the theorem holds.
  \end{enumerate}
