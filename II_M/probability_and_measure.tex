...
\begin{proof}
  Suppose that $\chi$ is uniformly integrable. For any $k$, and $X \in \mathcal{X}$ by Chebyshev inequality, we have
  \[
...
\begin{cor}
  ...
  Hence, finite collection of $L^1$ functions is uniformly integrable.
\end{cor}
...
\begin{proof}
  ...
  \[
    \E[|X_n - X| = \E\left[ |X_n - X| (\mathbf{1}_{|X_n - X| \leq \varepsilon} + \mathbf{1}_{|X_n - X| > \varepsilon})\right] \leq \varepsilon + 2C \P\left[|X_n - X| > \varepsilon\right].
  \]
