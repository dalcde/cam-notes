...
\end{proof}
Recall that we proved the converse of this statement for metric spaces. However, the converse is \emph{not} true for topological spaces in general. What we do have is the following result:
...
\begin{eg}\leavevmode
  \begin{enumerate}
    ...
    \item Let $X = [0, 1]\cap \Q$. Let
      ...
      \]
      for some irrational $\alpha$ in $(0, 1)$ (e.g.\ $\alpha = \sqrt{2}^{-1}$).
