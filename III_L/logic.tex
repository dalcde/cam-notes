...
\begin{thm}[$smn$ theorem]\index{$snm$ theorem}
  ...
  \[
    \{e\}(b, a) = \{s(e, b)\}(a).
  \]
  Here $\{e\}$ refers to the program coded by $e$.\index{$\{e\}$}
...
\[ % introduce list notation properly
...
Next we need the infinite list of natural numbers. Computer scientists call these \term{streams}. This is a fixed point for
\[
