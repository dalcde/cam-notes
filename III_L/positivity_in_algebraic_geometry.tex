...
\[
  ...
  \end{tikzcd}
\]
The composition is then just hte $m$th veloromes of $\varphi|_{\mathcal{L}}$. % fix the v-something word.

\begin{thm}[Jitaka] % check
  ...
  \[
    ...
    \end{tikzcd} % vertical maps are birational
  \]
\end{thm}
