...
\]
Then some $I_p$ has to occur infinitely often, and then we are done.
...
We have previously seen that the answer is trivially yes for $f(1, 2)$. It is a non-trivial theorem that $f(1, 3)$ exists, and in fact $f(1, 3) \leq 24$. We don't know anything more than that.
