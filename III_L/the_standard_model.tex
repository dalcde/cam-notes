...
\[
  \brak{p_1, p_2, \cdots} S \bket{k_A, k_B, \cdots} = _{\mathrm{out}}\braket{p_1, p_2, \cdots}{k_A, k_b, \cdots}_{\mathrm{in}} = \lim_{t \to \infty} \brak{p_1, p_2, \cdots} e^{-iH2T} \bket{k_A, k_B, \cdots}
\]
We can write
\[
