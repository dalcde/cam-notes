...
\begin{lemma}[Parallel transport]
  Let $t_0 \in I$ and $\zeta \in T_{\gamma(t_0)} M$. Then there exists a unique parallel vector field $V \in J(\gamma)$ such that $V(t_0) \xi$. We call $V$ the \term{parallel transport} of $\zeta$ along $\gamma$.
\end{lemma}
