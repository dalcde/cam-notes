...
Estimates like this that control a solution without needing to construct it are known as \term{a priori estimates}. These are often crucial to establish the existence of solutions (cf.\ Garding).
...
\end{thm}
\begin{proof}
  We use \term{Galerkin's method}. We can think of our PDE as an ODE on the infinite-dimensional space $H^1_0(U)$. Since we don't know how to solve ODEs in infinite dimensional spaces, we project our equation onto a finite-dimensional subspace, and then take the limit.
