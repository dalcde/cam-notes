...
We know move on to classify the irreducible representations of $\SU(2)$.
...
\end{thm}
Again, we get a complete set. A complete list of all irreducible representations, given in a really nice form. This is spectacular.
\end{document}
