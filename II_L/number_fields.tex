...
We have an alternative proof (sketch) using the Chinese remainder theorem.
\begin{proof}
...
\end{defi}
This classification of the behaviour of the prime ideals is very important in understanding the field, but unfortunately we will not get into the applications.
