...
\begin{proof}
  ...
  \begin{align*}
    ...
    &= (\psi, \psi) + \lambda(\phi, \psi) + \lambda(\psi, \phi) + \lambda^*(\phi, \psi) + |\lambda|^2 (\phi, \phi) \geq 0.
  \end{align*}
...
with
\[
  \lambda = \frac{m^2}{4\pi \varepsilon_0 \hbar^2},\quad \kappa^2 = \frac{-\hbar^2 \kappa^2}{2 m_e}.
\]
...
\[
  E_n = -\frac{\hbar^2}{2 m_e} \frac{\lambda^2}{n^2} = -\frac{1}{2}m_e \left(\frac{e^2}{4 \pi \varepsilon_0 \hbar^2}\right) \frac{1}{n^2}.
\]
