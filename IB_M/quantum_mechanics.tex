...
This is generally hard to solve. Instead, we are going to find stead states of this system. One way to do so is to spread the wavefunction out and turn it into a momentum eigenstate. But if we do so, we have to think about the problem of normalization, which is troublesome. Another way to do so is to consider the case where there are many particles, and they look more like waves than particles.
\end{document}
